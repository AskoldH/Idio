...
class Migration(migrations.Migration):
    ...
    def insertData(apps, schema_editor):
        ...
        edu_video_4 = EduVideoModel(
            name="Van Smoot je k mání", video_file=video_file_4,
        ...
        subtitles_info_4_5 = SubtitlesInfoModel(start_time="5.5",
        ...
        subtitles_info_4_6 = SubtitlesInfoModel(start_time="8.5",
